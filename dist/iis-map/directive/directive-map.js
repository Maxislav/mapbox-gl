...
(function () {
  ...
  angular.module('iis-map').directive('mapGl', mapGl);
      ...
      link: function link(scope, el, attr) {
        ...
        function initMap(token) {
          ...
          var popup = new mapboxgl.Popup({
            closeOnClick: false,
            closeButton: false
          }).setLngLat([30.40, 50.40]).setHTML('<h1>Popup</h1>');
          // .addTo(map);
          ...
          var marker = new mapboxgl.Marker(div).setLngLat([30.40, 50.40]).addTo(map);
...
//# sourceMappingURL=directive-map.js.map
