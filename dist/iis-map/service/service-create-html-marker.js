 ...
 */
(function () {
  angular.module('iis-map').factory('factoryMarkerHtml', factoryMarkerHtml);
  ...
  function factoryMarkerHtml() {
    ...
    return {
      getHtmlElement: function getHtmlElement(property) {
...
//# sourceMappingURL=service-create-html-marker.js.map
